...
def main():
    ...
    parser.add_argument(
        ...
        default="gpu",
        choices=["gpu", "cpu"],
        help="Type of compute resource to create (gpu or cpu)",
    )
    ...
    if compute_type == "cpu":
        try:
            ...
            print(f"You already have a CPU cluster named {cpu_cluster_name}.")
            return
        ...
        try:
            ...
            print(f"You already have a GPU cluster named {gpu_cluster_name}.")
            return
